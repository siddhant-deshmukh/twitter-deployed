...
const FeedTweetComponent = ({ tweet , updateTweet, pageNum, indexNum}: { tweet: ITweet,  updateTweet: () => void, pageNum: number, indexNum: number }) => {
    ...
    <div 
      ...
      <div className="w-full flex flex-col ">
        ...
        <ul className="flex justify-between ">
          ...
          <li className="w-full">
            <button className="w-fit items-center flex justify-start space-x-1 pr-4  group hover:text-green-700 tweet-btn">
