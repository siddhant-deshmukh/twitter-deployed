      ...
      <div className="w-full flex flex-col px-3 pt-3 ">
        ...
        <div className="text-base font-normal text-left py-3">
          ...
          <div className="flex space-x-3 pt-2">
            ...
            <div className="flex ">
              <span className="text-black font-semibold">{tweet.num_views}&nbsp;</span>
              <span className="text-gray-500">Views</span>
            </div>
          </div>
        </div>

        <ul className="w-full flex justify-start space-x-3 py-3  border-t border-t-gray-200 ">
          <button className="flex  h-fit group">
            <span className="text-black font-semibold group-hover:underline">{tweet.num_retweet}&nbsp;</span>
            <span className="text-gray-500 group-hover:underline w-fit">Retweets</span>
          </button>
          <button className="flex  group">
            <span className="text-black font-semibold group-hover:underline">{tweet.num_likes}&nbsp;</span>
            <span className="text-gray-500 group-hover:underline w-fit">Likes</span>
          </button>
        </ul>
        <ul className="flex justify-between text-gray-400 border-y border-y-gray-200 ">
          <li className="w-full">
