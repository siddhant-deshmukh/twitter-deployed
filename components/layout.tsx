    ...
    return (
      <div className="flex relative h-screen w-screen dark:bg-black dark:text-white">
        ...
        >
          ...
          <TopNavBar />
          <main
            className="relative overflow-y-auto w-full sm:mx-0 side-left-padding  pt-8 pb-12 sm:pt-0 sm:pb-0"
          >
...
function SideNavbar({ authState }: { authState: IUser }) {
  ...
  return (
    <header className="ml-auto hidden sm:flex  flex-col px-1.5 xl:px-0.5 pt-2 pb-3   h-full justify-between  sm:w-[68px] xl:w-[272px] ">
      ...
      <button className="inline-flex space-x-2.5 items-center p-2.5 w-full rounded-full font-medium hover:bg-gray-100 hover:bg-gray-800 xl:w-full">
        {
...
function BottomNavBar() {
  ...
  return (
    <>
      <ul className="fixed bg-white dark:bg-gray-900 bg-opacity-80 dark:bg-opacity-80 flex border-t shadow justify-between  w-full sm:hidden bottom-0 left-0  h-12 ">
...
export function TopNavBar() {
  ...
  return (
    <>
      <ul className="fixed z-50 flex border-t bg-white dark:bg-gray-900 bg-opacity-80 dark:bg-opacity-80 shadow justify-between  w-full sm:hidden top-0 left-0  h-8 ">
        <button
          onClick={(event) => {
