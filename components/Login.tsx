...
const Login = () => {
  ...
  return (
    <div
      className='w-screen h-screen fixed bg-gradient-to-r to-[#1B3359] from-[#213D65] left-0 top-0  bg-opacity-50 '
    >

      {/* <img src="/twiiter-3d-logo.jpg"/> */}
      <div className='w-full h-full bg-auto  bg-left-bottom bg-no-repeat flex items-center'
      style={{ backgroundImage: 'url("twitter-3d-bg.jpeg")' }}
      >
        <div className='mx-auto lg:ml-auto  lg:mr-96 w-[500px] h-fit rounded-2xl p-5 border bg-black text-white bg-opacity-50 shadow '>
