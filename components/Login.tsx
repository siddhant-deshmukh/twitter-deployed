...
const Login = () => {
  ...
  return (
    <div className='flex items-center w-screen h-screen fixed left-0 top-0 '>
      <div className='mx-auto w-[500px] h-fit rounded-2xl p-5 border border-gray-200 shadow '>
        ...
        <h1 className='mt-3 text-3xl mx-auto w-fit text-gray-700 font-medium '>
          Twitter Clone
        </h1>
        <p className='my-6 text-center mx-auto w-fit max-w-xs text-gray-500'>
