                ...
                <div className='w-full px-4 py-2'>
                    ...
                    <ul className="w-full flex justify-start space-x-3">
                        <button className="flex  group">
                            <span className="text-black font-semibold group-hover:underline">{authorDetails.num_following || 78}&nbsp;</span>
                            <span className="text-gray-500 group-hover:underline w-fit">Following</span>
                        </button>
                        <button className="flex  h-fit group">
                            <span className="text-black font-semibold group-hover:underline">{authorDetails.num_followers || 27}&nbsp;</span>
                            <span className="text-gray-500 group-hover:underline w-fit">Followers</span>
                        </button>
                    </ul>
                </div>
                <div>
