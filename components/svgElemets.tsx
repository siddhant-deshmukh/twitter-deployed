export function HomeSVG({ strokeWidth, fill }: { strokeWidth: string, fill: 'none' | 'white' }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill={fill} viewBox="0 0 24 24" strokeWidth={strokeWidth} stroke="currentColor" className="w-6 h-6">
...
export function TweetIcon({ fill }: { fill: string }) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill={fill} className="w-7 h-7">
